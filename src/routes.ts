...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/api/searchDavid',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.getBowieData.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/api/getElvisAlbums',
        function(request: any, response: any, next: any) {
            const args = {
            };
            ...
            const promise = controller.getElvisAlbums.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/api/searchArtist',
        function(request: any, response: any, next: any) {
            const args = {
                searchString: { "in": "query", "name": "searchString", "required": true, "dataType": "string" },
            };
            ...
            const promise = controller.searchArtist.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/api/networkTest',
        function(request: any, response: any, next: any) {
            const args = {
            };
            ...
            const promise = controller.networkTest.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
